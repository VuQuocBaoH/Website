...
const CreateEvent = () => {
  ...
  const form = useForm<z.infer<typeof eventSchema>>({
    ...
    defaultValues: {
      ...
      image: "",
      category: "",
      schedule: [], // Khởi tạo lịch trình là một mảng rỗng
    },
  });
  ...
  const onSubmit = async (values: z.infer<typeof eventSchema>) => {
    try {
      ...
      if (!token || !currentUsername) {
        toast.error("Authentication required or username missing. Please log in again.");
        navigate('/signin');
        return;
      }
      ...
      const eventData = {
        ...
        organizerDescription: `Event organized by ${currentUsername}.`,
